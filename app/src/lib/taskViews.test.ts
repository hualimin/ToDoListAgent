...
function mk(p: Partial<Task>): Task {
  return { id: p.id ?? 'x', user_id: 1, title: p.title ?? 't', content: '', input_source: 'text', urgency: 'normal', status: p.status ?? 'todo', due_at: p.due_at ?? null, scheduled_at: null, board_order: 0, created_at: '2026-06-20T00:00:00Z', updated_at: p.updated_at ?? '2026-06-24T00:00:00Z', deleted_at: null, sync_state: 'clean', image_data: null, group_id: null }
}
describe('taskViews', () => {
  it('groupByDay 按日分组', () => {
